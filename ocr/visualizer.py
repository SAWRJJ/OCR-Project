...
class Visualizer:
    ...
    def draw_red_lines(img_path, rec_polys_with_text, out_path="ocr_result_with_red_lines.jpg", 
        ...
        for item in rec_polys_with_text:
            ...
            top_ext = ImageProcessor.choose_one_sided_extension(raw_img, top_line[0], top_line[1], extend_length=300,min_non_bw_pixels=0)
            bottom_ext = ImageProcessor.choose_one_sided_extension(raw_img, bottom_line[0], bottom_line[1], extend_length=300,min_non_bw_pixels=0)

            top_ext = ImageProcessor.extend_opposite_side_for_small_box(top_line[0], top_line[1], top_ext, box_width)
            bottom_ext = ImageProcessor.extend_opposite_side_for_small_box(bottom_line[0], bottom_line[1], bottom_ext, box_width)
