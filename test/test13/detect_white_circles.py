...
from ocr.find_boundary_dark import find_closed_dark_regions
...
def find_white_circles(img, white_threshold=200,textbox_center=None,poly=None,output_path=None,min_circularity=0.8):
...
def main():
    ...
    for r in results:
        ...
        diameter = 2 * r['radius']
        if dist <= 300 and not point_in_poly(r['center'], poly) and border_dist >= diameter:
